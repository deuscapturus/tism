    ...
    return m(
      ...
      m("div[class=modal-content]", [
        m(
          ...
          m("h5[class=modal-title]", vnode.attrs.title)
        ),
        m("div[class=modal-body]", [
          m(
            "p[style=word-wrap: break-word; white-space: pre-wrap; font-family: monospace; line-height: 1;]",
            vnode.attrs.message
          ),
          m(
            "button[class=close]",
    ...
    return m
      ...
      .then(function(result) {
        ...
        m.render(
          ...
          m(modal, { message: result.pubkey, title: "GPG Public Key" })
        );
      })
      .catch(function(e) {
        m.render(
          document.getElementById("tokenModal"),
          m(modal, { message: e.message, title: "Error" })
        );
      });
  },
